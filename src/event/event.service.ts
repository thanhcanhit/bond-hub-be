...
export class EventService {
  ...
  // Call events
  emitCallIncoming(callId: string, initiatorId: string, receiverId: string, type: string, roomId: string, groupId?: string): void {
  ...
  emitCallRejected(callId: string, initiatorId: string, receiverId: string, roomId: string): void {
  ...
  emitCallEnded(callId: string, initiatorId: string, roomId: string, endedBy: string): void {
  ...
  emitCallParticipantJoined(callId: string, userId: string, roomId: string): void {
  ...
  emitCallParticipantLeft(callId: string, userId: string, roomId: string): void {
