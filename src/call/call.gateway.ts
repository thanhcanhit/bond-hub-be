...
export class CallGateway implements OnGatewayConnection, OnGatewayDisconnect {
  ...
  async handleGetProducers(
    ...
    try {
      ...
      const otherParticipants = this.callService.getOtherParticipants(roomId, userId);
  ...
  async handleSetRtpCapabilities(
    ...
    try {
      ...
      this.callService.setParticipantRtpCapabilities(roomId, userId, rtpCapabilities);
